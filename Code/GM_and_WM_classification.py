...
and {} White Matter images.'.format(TOTAL_IMAGES, GM_IMAGES, WM_IMAGES))


def make_image_array_list():
...
# slices and generate a corresponding list of labels. Make both of these into
# datasets then zip them together.
# Each image contains 767 slices.
image_array_list = make_image_array_list()
...
TRAIN_IMAGES = int(round(0.7 * TOTAL_IMAGES))  # 864
VAL_IMAGES = int(round(0.2 * TOTAL_IMAGES))  # 247
TEST_IMAGES = int(round(0.1 * TOTAL_IMAGES))  # 124
